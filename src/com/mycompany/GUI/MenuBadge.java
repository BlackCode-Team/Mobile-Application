 ...
 * @author MSI
 */
public class MenuBadge extends Form{
    Form current;
private Resources theme;


    public MenuBadge(Form prev){
   current = this;
    ...
    Button b1 = new Button("Ajouter badge");
    Button b2 = new Button("List des badges");

    b1.addActionListener(l -> new addBadge(current).show());
    b2.addActionListener(l -> new ListBadges(current).show());
